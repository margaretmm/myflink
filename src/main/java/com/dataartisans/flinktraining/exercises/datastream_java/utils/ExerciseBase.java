...
public class ExerciseBase {
	...
	public final static String pathToRideData = "D:/code/dataML/taxi/nycTaxiRides.gz";
	public final static String pathToFareData = "D:/code/dataML/taxi/nycTaxiFares.gz";
