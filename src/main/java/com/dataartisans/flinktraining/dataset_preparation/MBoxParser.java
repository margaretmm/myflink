...
public class MBoxParser {
	...
	public static void main(String[] args) throws Exception {
		...
		String input = params.get("input", "D:\\code\\dataML\\mail\\[alipay_sofa-boot] Fix proxy factory bean issue (#352).eml");
		String output ="D:\\code\\dataML\\mail\\output\\ret.csv";
	...
	public static class MBoxMailParser extends
		...
		private transient DateTimeFormatter inDF;//transient关键字标记的成员变量不参与序列化过程
